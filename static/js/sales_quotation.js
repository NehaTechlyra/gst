...
function calculateTotals() {
  ...
  if (document.getElementById("grand-total")) document.getElementById("grand-total").innerText = getDocumentCurrencySymbol() + ' ' + finalGrandTotal.toFixed(2);
  ...
  const baseGrandTotalValue = finalGrandTotal * fxRateValue;
